    ...
    $.fn.filterizr.prototype = {
        ...
        */
        _calcItemPositions: function() {
            ...
            rows = 0,
            //Item data
            itemWidth  = array[0]?.outerWidth()|| 0,
            itemHeight = 0,
            ...
            if (self.options.layout === 'horizontal') {
                ...
                for (i = 1; i <= array.length; i++) {
                    ...
                    itemHeight = array[i - 1]?.outerHeight()||0;
                    posArray.push({
                        left: left,
                        top: top
                    });
            ...
            //Layout of items for same height and varying width
                ...
                for (i = 1; i <= array.length; i++) {
                    ...
                    if (x > rowWidth) {
                        x 	 = 0;
                        left = 0;
                        top  += array[0]?.outerHeight()||0;
                        rows++;
                    }
                    else left += itemOuterWidth;
                }
                containerHeight = rows * array[0]?.outerHeight()||0;
            }
            //Layout for items of same width and varying height
                ...
                for (i = 1; i <= array.length; i++) {
                    ...
                    if (rows > 0) {
                        x = rows;
                        while (x > 0) {
                            top += array[i - (cols * x)]?.outerHeight()||0;
                            x--;
                        }
                    }
                    if (i % cols === 0) left = 0;
                ...
                for (i = 0; i < cols; i++) {
                    ...
                    while(array[index]) {
                        columnHeight += array[index]?.outerHeight()||0;
                        index += cols;
                    }
